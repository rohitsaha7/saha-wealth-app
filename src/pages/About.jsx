...
// ==========================================
// CORRECT IMPORT PATH FOR PAGES FOLDER
// ==========================================
import aboutImage from "../assets/images/about2.jpeg";

function About() {
  return (
    <div className="w-full min-h-screen bg-[#f8fafc] font-sans pt-[130px] pb-24 overflow-hidden flex flex-col items-center relative">
      
      {/* ================= BACKGROUND DECORATIONS ================= */}
      {/* Top Right Dotted Pattern */}
      <div className="absolute top-32 right-10 opacity-20 pointer-events-none hidden lg:block">
      ...
      <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[800px] h-[800px] border-[1px] border-blue-100 rounded-full pointer-events-none opacity-50"></div>
      <div className="absolute top-40 left-1/2 -translate-x-1/2 w-[1000px] h-[1000px] border-[1px] border-blue-50/50 rounded-full pointer-events-none"></div>

      {/* ================= MAIN CONTAINER ================= */}
      <section className="w-full max-w-[1300px] px-6 lg:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-10 items-center">
        ...
        <div className="flex flex-col items-start text-left w-full pr-0 lg:pr-8">
          ...
          <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-100 border-b-4 border-b-blue-500 hover:-translate-y-1 transition-transform duration-300 group flex flex-col h-full">
              ...
              <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-blue-500 ml-auto group-hover:bg-blue-50 transition-colors">
                <ArrowRight size={14} />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-100 border-b-4 border-b-emerald-500 hover:-translate-y-1 transition-transform duration-300 group flex flex-col h-full">
              ...
              <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-emerald-500 ml-auto group-hover:bg-emerald-50 transition-colors">
                <ArrowRight size={14} />
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-[0_8px_30px_rgba(0,0,0,0.04)] border border-slate-100 border-b-4 border-b-purple-500 hover:-translate-y-1 transition-transform duration-300 group flex flex-col h-full">
              ...
              <div className="w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center text-purple-500 ml-auto group-hover:bg-purple-50 transition-colors">
                <ArrowRight size={14} />
              </div>
            </div>
        ...
        <div className="relative w-full h-full min-h-[500px] flex items-center justify-center mt-10 lg:mt-0">
          ...
          <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 z-20 w-[90%] sm:w-[80%] bg-white rounded-2xl p-5 sm:p-6 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-slate-100 flex items-center gap-4 sm:gap-5">
